...
const TEAM_MEMBERS = [
  {
    image: `${process.env.PUBLIC_URL}/images/team/jagudelo.webp`,
    name: "Jorge Agudelo",
  ...
  {
    image: `${process.env.PUBLIC_URL}/images/team/luthar.webp`,
    name: "Andreas Luthar",
  ...
  {
    image: `${process.env.PUBLIC_URL}/images/team/kompresser.webp`,
  ...
  {
    image: `${process.env.PUBLIC_URL}/images/team/stephen.webp`,
    name: "Stephen Martin",
  ...
  {
    image: `${process.env.PUBLIC_URL}/images/team/rgy.webp`,
    name: "Brian rgy",
      ...
      <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-20 sm:grid-cols-2 lg:max-w-4xl lg:gap-x-8 xl:max-w-none">
        {TEAM_MEMBERS.map((member, index) => (
          <li data-aos="fade-up" key={`team_${index}}`} class="flex flex-col gap-6 xl:flex-row">
            <img class="aspect-[4/5] w-52 flex-none rounded-2xl object-cover" src={member.image} alt={member.name} />
            <div class="flex-auto">
