  ...
  return (
    <div className="mx-auto max-w-7xl px-6 sm:mt-0 lg:px-8 " id="nftseries0">
      <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        <h2 data-aos="fade-up" className="text-3xl font-bold tracking-tight text-gold sm:text-4xl">NFT Series 0 Investor Round</h2>
...
To become an investor and enjoy all perks, please visit our mint page at <href>https://truffle.wtf/project/shelter-official-nft-series-0</href>
            </p>
          </div>
        </div>
      </div>
